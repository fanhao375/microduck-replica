...
| **C8** | 100 nF 0402 | `C307331` | **紧贴 LDO 输入脚**，吸高频尖峰 |
| **D1** | **TVS `SMAJ12A`**（或 `SMF12A` SOD-123FL） | 待核 | ⚠️ **必须贴在 3P 连接器旁**。截止 12 V > 满电 8.4 V；钳位 **19.9 V** < C6 的 25 V |
| **F1** | **PPTC 可恢复保险丝**，hold 100–200 mA，0805 | 待核 | 本板故障时不拖垮整条舵机总线（官方 HAT 用 TH1 100R 热敏是同一思路） |
