...
*✅ `.eprj2` 已更新到 2026-09-08 的最终版。⚠️ 目录里的 **PCB PDF / 原理图 PDF / STEP 仍是 09-06～09-07 的版本**，待重导。*
...
- **PCB PDF / 原理图 PDF / STEP 待重导** —— `.eprj2` 已更新到 09-08 最终版，
  但这三个仍是 09-06～09-07 的。（`getPdfFile()` 在板上有铺铜后接口挂住不返回，
  只能在界面里手动导）
