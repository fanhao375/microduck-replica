...
**Full detail:** [Hardware Spec Sheet](docs/硬件规格速查.md) ·
[Complete Derivation](docs/硬件方案逆向.md)
...
| [Actuator Selection](docs/执行器选型.md) | XL330 parameters, BAM M6 config, five calibrated PD sets, backlash modeling — plus **why closed-loop steppers do not work here, and what swapping to a Feetech STS3215 actually costs** (737 g vs 2107 g, measured) |
...
> Documents are written in Chinese. The tables, part numbers, addresses and diagrams are
> readable without it; machine translation handles the prose well.
